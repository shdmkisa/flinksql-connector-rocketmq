...
public class RocketMQConfig {
    ...
    //数据格式
    public static final String TYPE = "type"; // Required
    ...
    public static final String CONSUMER_OFFSET_RESET_TO = "restPolicy";
    ...
    public static final String CONSUMER_OFFSET_FROM_TIMESTAMP = "timeFrom";
